...
class FullScreenImageApp:
    ...
    def show_manual(self, event):
        ...
        # ==========================================
        # [แก้ไข] เพิ่มส่วนนี้เพื่อแก้ปัญหาบน Raspberry Pi
        # ==========================================
        top.update_idletasks() # อัปเดตหน้าต่างให้พร้อมก่อน
        top.grab_set()         # ล็อกการทำงานให้อยู่แค่หน้านี้ (ห้ามกดหน้าหลัก)
        top.focus_force()      # บังคับให้คีย์บอร์ด/เมาส์ มาอยู่ที่หน้านี้ทันที
        # ==========================================
